...
from mower.utils.vectors import Vec2
...
class TestDrawing(unittest.TestCase):
    ...
    def test_rect_union1(self):
        p1 = Polygon.from_points([Vec2(0, 0), Vec2(10, 0), Vec2(10, 10), Vec2(0, 10)])
        p2 = Polygon.from_points([Vec2(5, 5), Vec2(7, 5), Vec2(7, 15), Vec2(5, 15)])
        paths = p1.union(p2)[0]
    ...
    def test_rect_disjoint_union1(self):
        p1 = Polygon.from_points([Vec2(0, 0), Vec2(10, 0), Vec2(10, 10), Vec2(0, 10)])
        p2 = Polygon.from_points([Vec2(50, 50), Vec2(70, 50), Vec2(70, 150), Vec2(50, 150)])
        paths = p1.union(p2)[0]
    ...
    def test_union_degeneracies(self):
        p1 = Polygon.from_points([Vec2(0, 0), Vec2(10, 0), Vec2(10, 10), Vec2(0, 10)])
        p2 = Polygon.from_points([Vec2(10, 5), Vec2(15, 0), Vec2(15, 10)])
        paths = p1.union(p2)[0]
        self.assertEqual(2, len(paths))
        self.assertEqual(len(p1.points()), len(paths[0].points()))
        self.assertEqual(len(p2.points()), len(paths[1].points()))
    ...
    def test_union_degeneracies2(self):
        p1 = Polygon.from_points([Vec2(0, 0), Vec2(10, 0), Vec2(10, 10), Vec2(0, 10)])
        p2 = Polygon.from_points([Vec2(10, 0), Vec2(15, 0), Vec2(15, 10)])
        paths = p1.union(p2)[0]
        self.assertEqual(2, len(paths))
        self.assertEqual(len(p1.points()), len(paths[0].points()))
        self.assertEqual(len(p2.points()), len(paths[1].points()))
    ...
    def test_union_degeneracies3(self):
        p1 = Polygon.from_points([Vec2(0, 0), Vec2(10, 0), Vec2(10, 10), Vec2(0, 10)])
        p2 = Polygon.from_points([Vec2(10, 0), Vec2(15, 0), Vec2(15, 5), Vec2(10, 5)])
        paths = p1.union(p2)[0]
        self.assertEqual(2, len(paths))
        self.assertEqual(len(p1.points()), len(paths[0].points()))
        self.assertEqual(len(p2.points()), len(paths[1].points()))
    ...
    def test_union_degeneracies4(self):
        p1 = Polygon.from_points([Vec2(0, 0), Vec2(10, 0), Vec2(10, 10), Vec2(0, 10)])
        p2 = Polygon.from_points([Vec2(10, 3), Vec2(15, 0), Vec2(15, 5), Vec2(10, 5)])
        paths = p1.union(p2)[0]
        self.assertEqual(2, len(paths))
        self.assertEqual(len(p1.points()), len(paths[0].points()))
        self.assertEqual(len(p2.points()), len(paths[1].points()))
